...
public class MenuCliente extends javax.swing.JFrame{
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (fila == -1){
            JOptionPane.showMessageDialog(null, "No se seleccionó fila");
             ...
             nom = jTable1.getValueAt(fila, 1).toString();
             ape = jTable1.getValueAt(fila, 2).toString();
             email = jTable1.getValueAt(fila, 3).toString();
             direcc = jTable1.getValueAt(fila, 4).toString();
    ...
    private void ModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ModificarMouseClicked
        if (!id.isEmpty()){
            limpiarTabla();
            DatoCliente c = new DatoCliente(id,nom,ape,direcc,email,fecha);
            c.setVisible(true);
            this.dispose();
        }else{
            JOptionPane.showMessageDialog(null, "No se seleccionó fila");
    ...
    private void eleminar() {
        ...
        try{
            if (fila < 0){
                ...
                String sql = "delete from clientes where id='"+jTable1.getValueAt(fila, 0).toString()+"'";
    ...
    private void consulta(String nombre) {
        ...
        if (nombre.equals("")){
            ...
            sql ="Select * from clientes where nombre+apellidos like '%"+nombre+"%'";
        }

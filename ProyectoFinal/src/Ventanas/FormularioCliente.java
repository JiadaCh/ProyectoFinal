...
public class FormularioCliente extends javax.swing.JFrame {
    ...
    private void AceptarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AceptarMouseClicked
        if (TxtID.getText().isBlank() || TxtNombre.getText().isBlank() || TxtApellidos.getText().isEmpty() || TxtDireccion.getText().isEmpty() || TxtEmail.getText().isBlank()) {
            JOptionPane.showMessageDialog(null, "Formulario sin rellenar");
        } else {
            try {
                ps = cx.getConexion().prepareStatement("Select * from clientes where id='"+TxtID.getText()+"'");
                rs = ps.executeQuery();
                if (rs.next()){
                    ...
                    ps = cx.getConexion().prepareStatement("insert into clientes (id,nombre,apellidos,direccion,email,fechaNac) value(?,?,?,?,?,?)");
